...
const LessonSelection = lazy(() =>
  import("./components/05-pages/LessonSelection")
);
const Calendar = lazy(() => import("./components/05-pages/Calendar"));
const ScheduleLesson = lazy(() =>
  import("./components/05-pages/ScheduleLesson")
);
const MyLessons = lazy(() => import("./components/05-pages/MyLessons"));
const CustomerReviews = lazy(() =>
  import("./components/05-pages/CustomerReviews")
);
